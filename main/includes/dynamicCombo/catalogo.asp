...
<%  
 ...
 InstrSQL = "EXEC spObtieneCatalogo '" & Catalogo & "','" & Session("idEmpresa")& "'" 'Busca el catálogo a procesar
 
 if left(catalogo,2)="||" THEN
  InstrSQL = "SELECT 0 AS IdCatalogo,'" & Session("idEmpresa")& "' AS IdEmpresa,'" & Catalogo _
