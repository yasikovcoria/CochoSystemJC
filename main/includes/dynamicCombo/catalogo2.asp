...
<%  
 ...
 InstrSQL = "EXEC spObtieneCatalogo '" & Catalogo & "','HGOV14'" 'Busca el catálogo a procesar
 
 if left(catalogo,2)="||" THEN
  InstrSQL = "SELECT 0 AS IdCatalogo,'HGOV14' AS IdEmpresa,'" & Catalogo _
 ...
 IF esEstatico = 0 THEN
  ...
  End If
 END IF 
 CALL fnCierraRS("FacturacionCFDI")
...
'InstrSQL = ""
 ...
 CALL fnCierraDB("FacturacionCFDI")
%>
<script>
