...
<%  
 ...
 Response.Write "<div id=""layCatalogo"" style=""background-color:#F0F0F0;position:absolute;visibility:hidden;top:0px;left:0px;width:" & ancho+20+auxAnchoMostrarFooter & "px;height:" & alto-5+auxAltoMostrarFooter & "px;overflow-x:hidden;overflow-y:scroll;border: 1px solid #7499C5;"">"
...
END IF
 IF InstrSQL <> "" THEN 'Sólo entra si existe una consulta maestra
  ...
  Response.Write "<tbody id=""bodytable"" style=""background-color:rgba(135, 226, 104, 0.70);"">"
  ...
  DO WHILE RSCatalogo.EOF <> TRUE 'Se imprimen los registros de la página solicitada
   if i<tamPagina Then 'Termina si se cumple con los registros a mostrar
    Response.Write "<tr class=""ContenidoDynamicCombo"" id=""id" & i & """ name=""id" & i & """ onClick=""procesa(" & i & ");"" title=""Seleccionar Registro"">"
    ...
    Response.Write "</tr>"
    Response.Write "<div id=""alay" & i + 0 & """ style=""background-color:#F0F0F0;visibility:hidden;top:0px;position:absolute;background-color:#FFFFFF"">" & RSCatalogo.Fields("ID") & "</div>"
   Else
    EXIT DO
   End If
   i = i + 1
 ...
 IF MostrarFooter = "1" THEN
  Response.Write "<div id="""" align=""center"" style=""background-color:rgba(135, 226, 104, 0.70);position:absolute;visibility:visible;top:" & alto-5
  Response.Write "px;left:-2px;width:" & ancho +22 & "px;height:20px;overflow: no;"" class=""paginacion"">"
  Response.Write "<table style=""padding-top:0px;""  class="""" width=""" & ancho +26 & "px"" align=""center"">"
