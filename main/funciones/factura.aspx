...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function agregaRenglonInput(divContenedor) {
            ...
            var combo = '<option value="">Seleccione una opcion</option><option value="1">KILO</option><option value="2">GRAMO</option><option value="3">METRO LINEAL</option><option value="4">METRO CUADRADO</option><option value="5">METRO CUBICO</option><option value="6">PIEZA</option><option value="8">LITRO</option><option value="9">PAR</option><option value="11">MILLAR</option><option value="12">JUEGO</option><option value="14">TONELADA</option><option value="20">CAJA</option><option value="21">BOTELLA</option><option value="22">HORAS</option><option value="23">FLETE</option><option value="24">BULTO</option><option value="25">CUBETA</option><option value="26">GALÓN</option>';
...
<body onload="javscript:muestraMetodoPago();fnCargaUnidad();">
    <form id="form1" runat="server">
        <input type="text" id="accion" name="accion" value="" />
        <input type="hidden" id="IdclienteM" runat="server" name="IdclienteM" value="" />
        

    <div id="contenedor" style="overflow:hidden;">
        <table>
            <tr>
    ...
    <table border="0" style="width: 775px" id="tablaFactura">
        ...
        <tr>
            ...
            <td>$ <input type="text" style="width:60px;" onkeyup="javascript:fnTotalImporte('0');" id="precioM0" name="precioM0" value="0" /></td>
            <td>$ <input type="text" style="width:60px;" id="importeM0" name="importeM0" runat="server" value="0" /></td>
        ...
        <table style="position:fixed; left:35%; font-size:12px;">
            <tr><td style=" font-size:12PX; margin-bottom:1px;">SubTotal </td><td>$ <input style="width:80px;" type="text" id="subTotalM" name="subTotalM" value="0" /></td></tr>
            <tr ><td style="font-size:12PX">Iva 16 %</td><td>$ <input style="width:80px"; type="text" id="ivaM" name="ivaM" value="0" /></td></tr>
            <tr ><td style="font-size:12PX"> Ret Iva (-) </td><td>$ <input style="width:80px"; type="text" id="ivaRetM" name="ivaRetM" value="0" /></td></tr>
             <tr><td style="font-size:12PX"> Ret Isr (-) </td><td>$ <input style="width:80px"; type="text" id="isrRetM" name="isrRetM" value="0" /></td></tr> 
            <tr><td style="font-size:12PX">Ret 5%(-)</td><td>$ <input type="text" style="width:80px"; id="ret5M" name="ret5M" value="0" /></td></tr>
            <tr><td style="font-size:12PX">Total Factura </td><td>$ <input style="width:80px"; type="text" id="totalFacM" name="totalFacM" value="0" /></td></tr>
        
        </table>
        
    </div>
        
        <div style="position:relative; top: 116px; left: 6px; width: 440px; overflow:hidden;">
        ...
        <table style="position:absolute; border-bottom:solid 1px; border-top:solid 1px; overflow:hidden; border-left:solid 1px; border-right:1px; left: 844px; top: 112px; height: 185px;">
            
            <tr ><td style="font-size:12PX">Forma de Pago SAT: </td>
                <td >
                    <select id="formaPagoM" name="formaPagoM" runat="server" style="width:100px; border-radius:5px;">
                        <option value="">Seleccione una opcion</option>
            ...
            <tr>
                <td style="font-size:12PX">Metodo de Pago SAT:</td>
                <td>
                    <select id="metodoPagoM" name="metodoPagoM" runat="server" style="width:100px; border-radius:5px;">
                        <option value="">Seleccione una opcion</option>
            ...
            <tr >
                <td style="font-size:12PX">Condicion de Pago:</td>
                <td>
                    <select id="condicionPagoM" name="condicionPagoM" runat="server" style="width:100px; border-radius:5px;">
                        <option value="">Seleccione una opcion</option>
